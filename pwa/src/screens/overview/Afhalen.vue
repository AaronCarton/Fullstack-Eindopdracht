      ...
      <div class="grid-rows-auto grid grid-cols-4 gap-6">
        ...
        >
          ...
          <div class="flex w-full items-center justify-between p-4">
            ...
            <p class="self-end justify-self-end text-xl">€16.99</p>
          </div>
          <div
            class="mt-110 mb-3 flex w-full justify-between rounded-lg bg-neutral-200 p-3"
          >
            <p class="text-xl font-bold">Total price</p>
            <p class="text-xl">€16.99</p>
          </div>
          <button
            class="w-full rounded-lg bg-red-700 px-6 py-2 font-bold text-neutral-50"
          >
            Checkout
          </button>
        </div>
